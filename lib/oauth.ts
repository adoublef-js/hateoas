import { Context, Next, OAuth2Client, createAuth0OAuth2Client } from "deps";
...
export async function injectOauthClient(
    c: Context<{ Variables: Oauth2Variables }>,
    next: Next
) {
